...
if [[ $zenityThemeResult == "spearmint-default" ]]; then
  ...
  cd /$HOME/spearmint-customizer/Debian/9/spearmint-default-GNOME/
...
if [[ $zenityThemeResult == "macOS-dark" ]]; then
  ...
  cd /$HOME/spearmint-customizer/Debian/9/macOS-GNOME
  mkdir OSX_ONE
  sudo tar -xf OSX_ONE9.2.tar.xz --directory /$HOME/spearmint-customizer/Debian/9/macOS-GNOME/OSX_ONE
  cd /$HOME/spearmint-customizer/Debian/9/macOS-GNOME/OSX_ONE
...
if [[ $zenityThemeResult == "macOS-light" ]]; then
  ...
  cd /$HOME/spearmint-customizer/Debian/9/macOS-light-GNOME/
  mkdir OSX_ONE
  sudo tar -xf OSX_ONE9.2.tar.xz --directory /$HOME/spearmint-customizer/Debian/9/macOS-light-GNOME/OSX_ONE
  cd /$HOME/spearmint-customizer/Debian/9/macOS-light-GNOME/OSX_ONE
  sudo cp -r OSX_ONE /usr/share/icons
  gsettings set org.gnome.desktop.interface icon-theme "OSX_ONE"
  cd /$HOME/spearmint-customizer/Debian/9/macOS-light-GNOME/
...
if [[ $zenityThemeResult == "qogir-win" ]]; then
  ...
  cd /$HOME/spearmint-customizer/Debian/9/qogir-GNOME/
...
if [[ $zenityThemeResult == "materia" ]]; then
  ...
  cd /$HOME/spearmint-customizer/Debian/9/materia-GNOME/
...
if [[ $zenityThemeResult == "vimix" ]]; then
  ...
  cd /$HOME/spearmint-customizer/Debian/9/Vimix-GNOME/
  sudo tar -xf vimix-color.tar.xz
  cd /$HOME/spearmint-customizer/Debian/9/Vimix-GNOME/vimix-color/
